...
;    (:module sc :components ( (:file "scone-loader") ;cmu nlp KR, w/snomed contrib
;               ) :serial t)
;    (:module in :components ( (:file "ssheet3") ;requires csv  ;has globals needed later
;                (:file "silver") ;for NP+mod    ;might goto ./test
;                (:file "j27") ;silver for CUIs    ;might goto ./test
;               ) :serial t)
;    (:module test :components ( (:file "test") ;was in in/..
;               ) :serial t)
;    (:module out :components ( (:file "ss-out") ;was in ld3d
;               ) :serial t)
;    (:module alg :components ( ;  (:file "alg") ;from v2, output to alg-tab
